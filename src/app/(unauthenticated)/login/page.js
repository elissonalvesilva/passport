    ...
    <>
      <div className='w-full h-full flex flex-col justify-center px-2'>
        <div className='flex flex-col justify-center items-center py-8 px-5'>
          <div className='bg-primary w-10 h-10 rounded-full flex justify-center items-center mb-3'>
            <GiPlanetConquest className="text-xl text-white" />
          </div>
        ...
        <FormProvider {...createHolderForm}>
          <form onSubmit={handleSubmit(createHolder)}>
            ...
            <div className="w-full text-right">
              <span className="text-primary text-xs font-light">Esqueceu sua senha ?</span>
            </div>
            <Button type="submit" className='bg-primary text-white mt-10'>Entrar</Button>
          </form>
        </FormProvider>
      </div>
    </>
